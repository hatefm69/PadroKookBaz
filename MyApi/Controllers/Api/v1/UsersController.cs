...
//        ////[Authorize(Roles = "Admin")]
//        //[AllowAnonymous]
//        //public virtual async Task<ActionResult<List<User>>> GetImages(CancellationToken cancellationToken)
//        //{
//        //    //var userName = HttpContext.User.Identity.GetUserName();
//        //    //userName = HttpContext.User.Identity.Name;
//        //    //var userId = HttpContext.User.Identity.GetUserId();
...
//        //    var users = await userRepository.TableNoTracking.Select(x => new { x.Avatar, x.Id }).ToListAsync(cancellationToken);
//        //    return Ok(users);
//        //}
...
//        //[HttpGet("{id:int}")]
//        //[ActionName("GetImage")]
//        //public virtual async Task<ApiResult<string>> Get(int id, CancellationToken cancellationToken)
//        //{
//        //    var user2 = await userManager.FindByIdAsync(id.ToString());
//        //    var role = await roleManager.FindByNameAsync("Admin");
